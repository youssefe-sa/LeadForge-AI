...
function getSectorTemplate(sector: string) {
  ...
  return SECTOR_TEMPLATES[normalizedSector as keyof typeof SECTOR_TEMPLATES] || SECTOR_TEMPLATES.plomberie;
}
...
export function generateSimpleSite(lead: SimpleLead): string {
